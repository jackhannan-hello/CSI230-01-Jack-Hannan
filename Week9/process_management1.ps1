...
Export-Csv -Path "C:\Users\champuser\CSI230-01JHannan\Week9\processManagemetStopped.csv"

cd "C:\Users\champuser\CSI230-01JHannan\Week9"
...
Export-Csv -Path "C:\Users\champuser\CSI230-01JHannan\Week9\processManagemetfiles.csv" -NoTypeInformation
